...
import { type BottomBarTab, type SideSubmenuItem, WorkspaceBottomBar } from '@/features/workspace/components/WorkspaceBottomBar';
...
const academicSideSubmenuItems: SideSubmenuItem[] = academicSectionOptions;
...
export function AdminWorkspace({ onSignOut, session }: AdminWorkspaceProps) {
  ...
  return (
    <SafeAreaView style={[styles.safeArea, desktop && styles.desktopSafeArea]}>
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView
          ...
          contentContainerStyle={[styles.scrollContent, desktop && styles.desktopScrollContent, { paddingBottom: insets.bottom + 160 }]}>
        ...
        <WorkspaceBottomBar
          ...
          sideSubmenu={{
            activeId: activeAcademicSection,
            items: academicSideSubmenuItems,
            parentId: 'academico',
            onPress: (sectionId) => {
              setActiveTab('academico');
              setActiveAcademicSection(sectionId as AcademicSectionId);
            },
          }}
          tabs={tabs}
          tone={bottomBarTone}
  ...
  return (
    <>
      <PageTitle
        ...
        title="Académico"
      />
      {showInlineNav ? <AcademicSectionNav activeSection={activeAcademicSection} onChange={onAcademicSectionChange} /> : null}
  ...
  return (
    <>
      <PageTitle
        ...
        subtitle="Actualiza tus datos de acceso y la imagen visible en BioMind"
        title="Perfil"
      />

      <View style={[styles.adminProfileCard, desktop && styles.adminProfileCardDesktop]}>
        <View style={[styles.adminProfileMain, desktop && styles.adminProfileMainDesktop]}>
          <Pressable onPress={pickProfilePhoto} style={[styles.adminAvatarWrap, desktop && styles.adminAvatarWrapDesktop]}>
            <UserAvatar name={name} photoUrl={photoUri || session.photoUrl} size={desktop ? 118 : 100} />
            <View style={styles.changePhotoButton}>
              <Text style={styles.changePhotoText}>Cambiar foto</Text>
            </View>
            <Text style={styles.profileRoleText}>{session.role}</Text>
          </Pressable>

          <View style={styles.adminProfileFormPanel}>
